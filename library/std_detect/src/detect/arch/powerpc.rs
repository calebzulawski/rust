...
features! {
    ...
    @MACRO_NAME_TARGET_FEATURE_ENABLED: is_powerpc_feature_enabled;
    @MACRO_TARGET_FEATURE_ENABLED_ATTRS:
    /// This macro tests, at compile time, whether a `powerpc` feature is enabled on powerpc platforms.
    ///
