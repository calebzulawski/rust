...
pub mod arch {
    ...
    #[unstable(feature = "target_feature_enabled", issue = "none")]
    pub use std_detect::{is_powerpc_feature_enabled, is_powerpc64_feature_enabled};
}
